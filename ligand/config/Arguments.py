...
# Main parameters
parser.add_argument(
    "--experiment_name", type=str, default='Transformer_ligand_pre_downsample512_group768size16', help="Name of experiment"
)
parser.add_argument(
...
parser.add_argument(
    "--ckpt", type=str, default='./checkpoints/ckpt-last.pth', help="ckpt path"
)
parser.add_argument(
    "--checkpoint", type=str, default='./checkpoints/Transformer_ligand_pre_downsample512_group768size16_new_epoch295.pth', help="weight for test"
)
