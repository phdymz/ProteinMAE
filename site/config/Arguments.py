...
# Main parameters
parser.add_argument(
    "--experiment_name", type=str, default='Transformer_site_inference', help="Name of experiment"
)
parser.add_argument(
...
parser.add_argument(
    "--batch_size", type=int, default=32, help="Number of proteins in a batch"
)
parser.add_argument(
...
parser.add_argument("--site", type=bool, default=True, help="Predict interaction site")
parser.add_argument(
    "--search",
    type=bool,
    default=False,
...
parser.add_argument(
    "--ckpt", type=str, default='./checkpoint/ckpt-last.pth', help="ckpt path"
)

parser.add_argument(
    "--checkpoint", type=str, default='./checkpoint/Transformer_site_batch32_yuanshi_epoch107', help="weight for test"
)

# ./checkpoint/Transformer_site_batch32_yuanshi_epoch107
# ./checkpoint/Transformer_site_batch32_yuanshi_pre6.11_epoch27.pth
